...
<ul>
  ...
  <li><a class="active" href="mchangepwd">Change Password</a></li>
...
<form method="post" action="updatemenpwd">

<table align=center>

<tr>
<td><label>Old Password</label></td>
<td><input type="password" name="mopwd" required></td>
</tr>
...
<td><input type="password" name="mnpwd" required></td>
</tr>
